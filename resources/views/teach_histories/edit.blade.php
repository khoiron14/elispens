...
<div class="main-wrapper">
    <form action="{{ route('teaches.update', $teach) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="js-states form-control @error('course_id') is-invalid @enderror"
                        ...
                        <option value="{{ $course->id }}" @selected(old('course_id',$teach->course_id)==$course->id)>
                ...
                <div class="form-group">
                    ...
                    <div class="form-control" id="semester">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="semester" id="semester-o" value="O" @checked(old('semester',$teach->semester)=='O')>
                            <label class="form-check-label" for="semester-o">Ganjil</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="semester" id="semester-e" value="E" @checked(old('semester',$teach->semester)=='E')>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" min="1900" max="2099" step="1" class="form-control @error('year') is-invalid @enderror" id="year" name="year"
                        value="{{ old('year',$teach->year) }}" placeholder="Tulis Tahun" required>
                    @error('year')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
